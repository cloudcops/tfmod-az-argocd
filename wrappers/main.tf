module "wrapper" {
  ...
  argocd_applicationset_memory       = try(each.value.argocd_applicationset_memory, var.defaults.argocd_applicationset_memory, "128Mi")
  ...
  argocd_dex_memory                  = try(each.value.argocd_dex_memory, var.defaults.argocd_dex_memory, "128Mi")
  ...
  argocd_notifications_memory        = try(each.value.argocd_notifications_memory, var.defaults.argocd_notifications_memory, "128Mi")
  argocd_redis_cpu_request           = try(each.value.argocd_redis_cpu_request, var.defaults.argocd_redis_cpu_request, "50m")
  argocd_redis_memory                = try(each.value.argocd_redis_memory, var.defaults.argocd_redis_memory, "128Mi")
  ...
  argocd_reposerver_memory           = try(each.value.argocd_reposerver_memory, var.defaults.argocd_reposerver_memory, "256Mi")
  argocd_server_cpu_request          = try(each.value.argocd_server_cpu_request, var.defaults.argocd_server_cpu_request, "100m")
  argocd_server_memory               = try(each.value.argocd_server_memory, var.defaults.argocd_server_memory, "256Mi")
