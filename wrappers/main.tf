module "wrapper" {
  ...
  gateway_listener_name                = try(each.value.gateway_listener_name, var.defaults.gateway_listener_name, "https-argocd")
  gateway_name                         = try(each.value.gateway_name, var.defaults.gateway_name, "eg-public")
  gateway_namespace                    = try(each.value.gateway_namespace, var.defaults.gateway_namespace, "eg-public")
